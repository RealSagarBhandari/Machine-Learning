...
8 specific experiments were executed to benchmark performance across different mathematical approaches:
...
- **The Scaling Effect:** As hypothesized, kNN performance saw significant gains when features were normalized. This effectively balanced the Euclidean distance contribution of high-variance variables like `redshift` against standard celestial coordinates.
